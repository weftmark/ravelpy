"""Shared endpoint test cases used by test_auth.py and oauth_scope_test.py."""

from dataclasses import dataclass, field

TEST_USER = "tester"  # placeholder username for user-scoped paths
...
class Case:
    ...
    @property
    def label(self) -> str:
        return f"{self.resource}.{self.method}"
...
# Only the authenticated-tier cases — used when running scope comparisons
AUTH_CASES: list[Case] = [c for c in CASES if c.expected == "authenticated"]
